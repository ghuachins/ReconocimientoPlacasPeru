========================================================================
    APLICACIÓN: CaractSVM Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación CaractSVM.  

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación CaractSVM.
