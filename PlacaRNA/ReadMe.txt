========================================================================
    APLICACIÓN: PlacaRNA Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación PlacaRNA.  

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación PlacaRNA.
