========================================================================
    APLICACIÓN: SegmentoCaracter Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación SegmentoCaracter.  

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación SegmentoCaracter.

SegmentoCaracter.vcxproj
...
SegmentoCaracter.vcxproj.filters
